...
// Add this to the createDraggableWindow function, right after the content div creation
...
automateButton.style.backgroundColor = '#2E2E2E';
automateButton.style.border = 'none';
automateButton.style.borderRadius = '5px';
automateButton.style.color = 'white';
automateButton.style.cursor = 'pointer';
automateButton.style.marginTop = '10px';
automateButton.style.fontFamily = 'Poppins, sans-serif';
...
automateButton.onclick = () => {
    if (!isAutomating) {
        ...
        automateButton.style.backgroundColor = '#ff4444';

        async function automateProcess() {
            while (isAutomating) {
                // Navigate to Roblox create account page
                window.location.href = 'https://www.roblox.com/createaccount';
...
content.appendChild(automateButton);
